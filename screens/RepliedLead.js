...
const OpenLead = ({ navigation }) => {
  const [repliedleadData, setRepliedLeadData] = useState([]);
  const [selectedRepliedLeadDetails, setSelectedRepliedLeadDetails] = useState({});
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Replied");
      setRepliedLeadData(leadData);
    } catch (error) {
  ...
  const fetchAllLeadDetails = async (leadId) => {
    try {
      ...
      setSelectedRepliedLeadDetails(leadDetails);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>Replied Lead</Text>
      </View>
      <FlatList
        data={repliedleadData}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Replied Lead Details</Text>
            
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Full Name:</Text>
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedRepliedLeadDetails?.industry || ''}
