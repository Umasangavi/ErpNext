...
const LostQuotationLead = ({ navigation }) => {
  const [LostQuotationLead, setLostQuotationLeadData] = useState([]);
  const [selectedLostQuotationLeadDetails, setSelectedLostQuotationLeadDetails] = useState({});
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Lost Quotation");
      setLostQuotationLeadData(leadData);
    } catch (error) {
  ...
  const fetchAllLeadDetails = async (leadId) => {
    try {
      ...
      setSelectedLostQuotationLeadDetails(leadDetails);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>LostQuotation Lead</Text>
      </View>
      <FlatList
        data={LostQuotationLead}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>LostQuotation Lead Details</Text>
            
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Full Name:</Text>
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLostQuotationLeadDetails?.industry || ''}
...
export default LostQuotationLead;
