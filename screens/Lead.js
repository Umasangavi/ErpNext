...
const Lead = ({ navigation }) => {
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Lead");
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>Lead</Text>
      </View>
      <FlatList
        data={leadData}
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedLeadDetails?.industry || ''}
