...
const InterestedLead = ({ navigation }) => {
  const [interestedLead, setInterestedLeadData] = useState([]);
  const [selectedInterestedLeadDetails, setSelectedInterestedLeadDetails] = useState({});
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Interested");
      setInterestedLeadData(leadData);
    } catch (error) {
  ...
  const fetchAllLeadDetails = async (leadId) => {
    try {
      ...
      setSelectedInterestedLeadDetails(leadDetails);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>Interested Lead</Text>
      </View>
      <FlatList
        data={interestedLead}
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedInterestedLeadDetails?.industry || ''}
