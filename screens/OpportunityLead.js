...
const OpportunityLead = ({ navigation }) => {
  const [opportunityLead, setOpportunityLeadData] = useState([]);
  const [selectedOpportunityLeadDetails, setSelectedOpportunityLeadDetails] = useState({});
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Opportunity");
      setOpportunityLeadData(leadData);
    } catch (error) {
  ...
  const fetchAllLeadDetails = async (leadId) => {
    try {
      ...
      setSelectedOpportunityLeadDetails(leadDetails);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>Opportunity Lead</Text>
      </View>
      <FlatList
        data={opportunityLead}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Opportunity Lead Details</Text>
            
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Full Name:</Text>
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedOpportunityLeadDetails?.industry || ''}
...
export default OpportunityLead;
