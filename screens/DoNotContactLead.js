...
const DoNotContactLead = ({ navigation }) => {
  const [doNotContactLead, setDoNotContactLeadData] = useState([]);
  const [selectedDoNotContactLeadDetails, setSelectedDoNotContactLeadDetails] = useState({});
  ...
  const fetchLeadData = async () => {
    try {
      ...
      const leadData = response.data.data.filter(lead => lead.status === "Do Not Contact");
      setDoNotContactLeadData(leadData);
    } catch (error) {
  ...
  const fetchAllLeadDetails = async (leadId) => {
    try {
      ...
      setSelectedDoNotContactLeadDetails(leadDetails);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.heading}>DoNotContact Lead</Text>
      </View>
      <FlatList
        data={doNotContactLead}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>DoNotContactLead Details</Text>
            
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Full Name:</Text>
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.title || ''}
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.email || ''}  
                placeholder="Email"          
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.website || ''} 
                placeholder="Website"                         
              />
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.mobile_no || ''}
            ...
            {/* <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.source || ''}
                placeholder="Source"            
              />
            </View> */}
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                value={selectedDoNotContactLeadDetails?.industry || ''}
...
export default DoNotContactLead;
